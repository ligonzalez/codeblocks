...
export default async function UpdateBlock({ params }: { params: { id: string } }) {
            ...
            <form action={updateBlock}>
                ...
                <div className="place-items-center h-screen">
                    <div className="mb-6 w-1/2">
                        ...
                        <input type="text" id="title" name="title" defaultValue={block?.title} 
                    ...
                    <div className="mb-6 w-1/2">
                        ...
                        <textarea id="code" name="code" rows={15} defaultValue={block?.code} 
